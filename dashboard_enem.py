...
[data-testid="stSidebar"] { background: #0f1320 !important; border-right: 1px solid #1e2438; }
[data-testid="stSidebar"] * { color: #c8ccd8 !important; }
[data-testid="stSidebar"] .stMultiSelect > div,
[data-testid="stSidebar"] .stSlider > div { background: #161b2e !important; border-radius: 8px; border: 1px solid #252d45; }

.dash-header { padding: 2rem 0 1.5rem; border-bottom: 1px solid #1e2438; margin-bottom: 2rem; }
.dash-title {
...
.dash-caption { font-size: 0.82rem; color: #5a6080; letter-spacing: 0.12em; text-transform: uppercase; margin-top: 0.5rem; font-weight: 500; }
...
.kpi-card:hover { border-color: #2e3a5e; transform: translateY(-2px); }
.kpi-card::before {
...
[data-testid="stTabs"] [role="tablist"] { background: #0f1320; border: 1px solid #1e2438; border-radius: 10px; padding: 4px; gap: 2px; }
...
[data-testid="stDataFrame"] { border: 1px solid #1e2438; border-radius: 10px; overflow: hidden; }
[data-testid="metric-container"] { background: #0f1320; border: 1px solid #1e2438; border-radius: 12px; padding: 1rem 1.2rem; }
[data-testid="stMetricValue"] { font-family: 'Syne', sans-serif !important; color: #e8eaf0 !important; }
</style>
